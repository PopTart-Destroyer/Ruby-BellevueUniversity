...
# Author:		T. J. FLESHER
# Date: 		April 22, 2017
# Class:		WEB312 - Bellevue University
#
# Description:	Page 144 - Reinforcement Exercises: Add 5 more sentences to
#				the typing challenge and adjust for 6 correct typed sentences
#
#--------------------------------------------------------------------------
...
class Test
  ...
  def present_test(challenge)
    ...
    if challenge == result then
      ...
      #Keep the player informed
      print "Incorrect!" +
	  "\n\nChallenge sentence: " + challenge +
	  "\n\nPlayer's sentenct: " + result +
	  "\n\nPress enter to continue."
  ...
  def determine_grade
	...
	#GRADING SYSTEM FOR CHALLENGE
	letterGrade = case $noRight
		when 9..10 then "A"
		when 8 then "B"
		when 7 then "C"
		when 6 then "D"
	...
	puts "Your letter grade for the typing challenge is: " + letterGrade +
	 "\n\nPress Enter to continue."
...
if answer == "n"  #See if the player elected not to play
  ...
  #ADDITIONAL 5 SENTENCES FOR CHALLENGE
  Typing_Test.present_test "The five boxing wizards jump quickly."
  Typing_Test.present_test "The quick brown fox jumps over the lazy dog."
  Typing_Test.present_test "How quickly daft jumping zebras vex."
  Typing_Test.present_test "Jinxed wizards pluck ivy from the big quilt."
  Typing_Test.present_test "Baseball is America's greatest pass time."
